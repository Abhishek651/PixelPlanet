...
class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Title
        const title = this.add.text(width / 2, 100, 'ECO-QUIZ', {
            fontSize: '64px',
            fontFamily: 'Arial Black',
            fill: '#3498db', // Blue color for quiz
            stroke: '#0f3460',
            strokeThickness: 8,
            shadow: {
                offsetX: 3,
        ...
        // Subtitle
        this.add.text(width / 2, 170, 'Test Your Eco Knowledge!', {
            fontSize: '24px',
            fontFamily: 'Arial',
            fill: '#eeeeee',
            fontStyle: 'italic'
        ...
        // Play Quiz Button
        const quizButton = this.createButton(width / 2, 320, '🧠 PLAY QUIZ', 0x3498db, () => {
        ...
        const instructions = this.add.text(width / 2, 480, 
            'Answer environmental questions and earn Knowledge Points (KP)!', {
            fontSize: '16px',
            fontFamily: 'Arial',
            fill: '#95a5a6',
            align: 'center',
