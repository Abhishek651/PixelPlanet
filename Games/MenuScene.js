...
class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        const playButton = this.createButton(width / 2, 280, '🎮 PLAY SORTING GAME', 0x27ae60, () => {
            this.scene.start('GameScene');
        });

        // Play Quiz Button
        const quizButton = this.createButton(width / 2, 370, '🧠 PLAY ECO QUIZ', 0x3498db, () => {
            this.scene.start('QuizScene');
        });

        // Instructions
        const instructions = this.add.text(width / 2, 480, 
            'SORTING GAME: Drag items to correct bins!\n' +
            'QUIZ: Answer environmental questions!\n' +
            'Earn Knowledge Points (KP) and learn!', {
            fontSize: '16px',
            fontFamily: 'Arial',
            fill: '#95a5a6',
            align: 'center',
